    ...
    <>
      ...
      <div className="hidden sm:block">
        <Header
          ...
          className="bg-header dark:bg-dark-border text-black dark:text-login dark:border-b dark:border-dark-border"
        />
      </div>
      ...
      <div className="block sm:hidden">
        <MobileHeader
          ...
          leftContent={leftContent}
          rightContent={rightContent}
          className="bg-header dark:bg-dark-border text-black dark:text-login"
        />
      </div>
    </>
  );
